...
const Dashboard = () => {
    ...
    */
    ...
    const totalBankInvestmentValue =
        bankWise.reduce(
            (
                total,
                item
                ...
                <div className="card-body">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="text-muted small">
                            ...
                            Money currently available in bank and cash accounts
                ...
                <div className="card-body">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="text-muted small">
                                ...
                                Investment portfolio and current returns
                    ...
                    <div className="row g-3">
                        ...
                        <SummaryCard
                            title="Return"
                            value={
                                investmentProfitLossPercentage
                            }
                            bg={
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div className="text-muted small">
                                ...
                                Account balance and investment value
